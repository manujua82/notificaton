...
const { processClientId, processClientSecret } = require('../config.js');
...
export const getWNSBearerToken = () => {
    ...
    const clientId = process.env.clientId || processClientId;
    const clientSecret = process.env.clientSecret || processClientSecret;
